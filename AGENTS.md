# RedactPro — Agent Runbook & Operating Directive

## 1. System Overview & Identifiers
* **App Name:** RedactPro
* **Bundle Identifier (iOS):** `com.hushtunnel.redactpro`
* **Package Name (Android):** `com.hushtunnel.redactpro`
* **URL Scheme:** `redactpro://`
* **Monetization Model:** Free download with a single **$8.99 Lifetime Non-Consumable IAP** lifetime unlock
* **Entitlement ID:** `pro`
...
* `https://www.hushtunnel.com/legal/redactpro-privacy`
* `https://www.hushtunnel.com/legal/redactpro-terms`
