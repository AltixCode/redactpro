...
export const useTheme = (): ThemeColors => {
  ...
  return {
    ...
    onPrimary: '#FFFFFF',
    primaryLight: isDark ? 'rgba(225, 29, 72, 0.15)' : 'rgba(225, 29, 72, 0.10)',
    primaryBorder: isDark ? 'rgba(244, 63, 94, 0.35)' : 'rgba(225, 29, 72, 0.25)',
    accent: isDark ? '#38BDF8' : '#0284C7', // sky-400
